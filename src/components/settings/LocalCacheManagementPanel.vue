...
<template>
  <div class="py-2.5 px-4">
    <div class="mb-1 text-[12px] font-medium text-gray-600 dark:text-gray-300">{{ t(store.settings.locale, 'settings.localCacheTitle') }}</div>
    <div class="mb-2.5 text-[10px] leading-relaxed text-gray-400">{{ t(store.settings.locale, 'settings.localCacheDesc') }}</div>

    <div class="mb-2 grid grid-cols-2 gap-2">
      <div class="rounded-xl border border-gray-100 bg-gray-50 px-2.5 py-2 dark:border-neutral-800 dark:bg-neutral-950">
    ...
    <div class="mb-1.5 flex items-center justify-between gap-2 rounded-xl border border-gray-100 bg-white px-2.5 py-1.5 dark:border-neutral-800 dark:bg-neutral-950">
      <div class="min-w-0">
    ...
    <div class="flex items-center justify-between gap-2 rounded-xl border border-gray-100 bg-white px-2.5 py-1.5 dark:border-neutral-800 dark:bg-neutral-950">
      <div class="min-w-0">
