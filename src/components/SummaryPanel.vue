      ...
      <div v-if="hasRateData" class="flex-1 grid grid-cols-4 gap-1.5">
        ...
        <div class="flex items-center justify-center bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-900/40 rounded-lg py-1.5 px-2">
          <div class="flex flex-col items-center">
            ...
            <span class="text-sm font-bold text-gray-800 dark:text-gray-100 font-mono leading-tight">{{ formatTokenValue(summaryWindowData.inputTokens + summaryWindowData.outputTokens, getTokenUnit(summaryWindowData.inputTokens, summaryWindowData.outputTokens)) }}</span>
